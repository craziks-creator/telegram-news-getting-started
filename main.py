...
ie1.set_title_selector('div#noticeschsl.tab-content>div.noticeTxt>div.noticeTable>div.table-responsive>table.table.table-bordered.table-striped>tbody>tr>td:nth-child(2)>span')  #id
ie1.set_paragraph_selector('div#noticeschsl.tab-content>div.noticeTxt>div.noticeTable>div.table-responsive>table.table.table-bordered.table-striped>tbody>tr>td:nth-child(4)')
